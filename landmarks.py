...
def visualize_landmarks(image, shape, display=True, output_path=None):
...
def predict_and_visualize(image_path, rect=None, display=True, output_path=None):
    ...
    # visualize
    visualize_landmarks(image, shape, display, output_path)
